    ...
    <>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-neutral-50 via-primary-50 to-accent-light/20">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 text-center">
          ...
          <h1 className="font-display text-4xl sm:text-5xl md:text-6xl font-semibold text-neutral-900 mb-6 leading-tight">
            Hadirkan <span className="text-gradient">Kebahagiaan</span>
            <br />di Setiap Momen
          </h1>
          <p className="text-neutral-600 text-lg md:text-xl mb-8 max-w-2xl mx-auto leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Link href="/catalog" className="btn-primary text-base px-8 py-3.5">Lihat Katalog →</Link>
            <Link href="/order" className="btn-outline text-base px-8 py-3.5">Pesan Sekarang</Link>
          </div>
          <div className="mt-16 grid grid-cols-3 gap-6 max-w-lg mx-auto">
            {[
              { value: `${hardcodeProducts.length}+`, label: "Pilihan Paket" },
      ...
      {/* Featured Products — client component, realtime dari Sheets */}
      <FeaturedProducts />
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-8">
            {featuredTestimonials.map((t, i) => (
              <div key={t.id} className="bg-white rounded-2xl p-6 border border-neutral-100 hover:shadow-md transition-shadow">
      ...
      <section className="py-20 bg-neutral-900">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 text-center">
          <h2 className="font-display text-3xl md:text-4xl font-semibold text-white mb-4">Siap Pesan Parcel Impianmu?</h2>
          <p className="text-neutral-400 mb-8">Hubungi kami sekarang dan dapatkan parcel terbaik untuk orang-orang tersayang</p>
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Link href="/order" className="btn-primary text-base px-8 py-3.5">Pesan Sekarang</Link>
            <a href="https://wa.me/6208551234202" target="_blank" rel="noopener noreferrer"
